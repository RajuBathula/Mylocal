						...
						<div class="row">
							<div class="col-lg-12">
								<form:form id="login-form" action="./registration"
									commandName="ManageUserProfileBean" method="POST" role="form"
									style="display: block;">
									...
									<div class="form-group">
										<form:input path="confirmPassword" type="password" id="password"
											tabindex="5" class="form-control" placeholder="ConfirmPassword"></form:input>
									</div>
									<div class="form-group">
									...
									<div class="row">
				                                    <div class="col-md-4">
				                                        <div class="form-group">
				                                            <label class="control-label"><label for="User_CompanyId">RegisteredAs:</label><span class="required">*</span></label>
				                                            <form:select class="form-control" path="roleName" style="">
